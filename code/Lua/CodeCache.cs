...
namespace Miku.Lua
{
    ...
    class CodeCache
	{
		...
		public static void SetCode(string filename, byte[] code)
		{
			// TODO do this check on init?
			if (!FileSystem.Data.DirectoryExists("cc"))
			{
				FileSystem.Data.CreateDirectory( "cc" );
			}
	...
	// System.Cryptography isn't available, and I want something a bit more robust than the default String.GetHashCode
	// Copied from https://gist.github.com/ameerkat/07a748c9b571289711ebaf61f4b596e9
