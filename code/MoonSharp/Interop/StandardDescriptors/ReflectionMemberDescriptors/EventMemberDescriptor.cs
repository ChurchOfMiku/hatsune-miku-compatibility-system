...
namespace MoonSharp.Interpreter.Interop
{
	...
	public class EventMemberDescriptor : IMemberDescriptor
	{
		...
		MultiDictionary<object, Closure> m_Callbacks = new MultiDictionary<object, Closure>(ReferenceEqualityComparer.Instance);
		Dictionary<object, Delegate> m_Delegates = new Dictionary<object, Delegate>(ReferenceEqualityComparer.Instance);
